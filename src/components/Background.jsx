...
const Background = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-purple-400 rounded-full filter blur-3xl opacity-10 translate-x-1/2 translate-y-1/2" />
      <div className="absolute top-1/2 left-1/2 w-96 h-96 bg-teal-400 rounded-full filter blur-3xl opacity-10 -translate-x-1/2 -translate-y-1/2" />
      ...
      >
        <div className="h-full flex flex-col p-6">
          {/* Title Section */}
          <div className="mb-8">
            <h2 className="text-2xl font-light text-gray-800">Killian's Club</h2>
          </div>
          ...
          {isSmallScreen && isSidebarOpen && (
            <button
              onClick={toggleSidebar}
              className="absolute top-4 right-4 p-2 rounded-lg hover:bg-gray-50 transition-colors"
            >
              <svg
                className="w-6 h-6"
                fill="none"
